...
mat4 mat4::affine_transformation(const vec3& scale, const vec3& rotation_origin,
...
mat4 mat4::affine_transformation(const vec4& scale, const vec4& rotation_origin,
                                  const quat& rotation, const vec4& translation) {
    return affine_transformation(
        vec3(scale.x, scale.y, scale.z),
        vec3(rotation_origin.x, rotation_origin.y, rotation_origin.z),
        rotation,
