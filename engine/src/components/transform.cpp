...
namespace sf::components {
    ...
    void Transform::update(stl::vector<Transform>& transforms) {
        PROFILE_FUNCTION();
        m_Transform = sf::math::mat4::affine_transformation(sf::math::vec3(m_Scale.x, m_Scale.y, m_Scale.z),
                                                            sf::math::vec3(m_Position.x, m_Position.y, m_Position.z), m_Rotation,
