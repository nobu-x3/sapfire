...
void VkPipelineState::create_graphics(VkDevice device, const GraphicsPipelineStateDesc& desc,
                                      VkPipelineLayout layout, VkRenderPass render_pass) {
    m_Device = device;
    m_IsCompute = false;

    // Load and compile shaders
    Shader vertex_shader = compile(device, ShaderType::Vertex, desc.shader_module.vertex_shader_path, desc.shader_module.vertex_entry_point);
    Shader fragment_shader = compile(device, ShaderType::Fragment, desc.shader_module.pixel_shader_path, desc.shader_module.pixel_entry_point);
...
void VkPipelineState::create_compute(VkDevice device, const ComputePipelineStateDesc& desc,
