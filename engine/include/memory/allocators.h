...
namespace sf {
    ...
    namespace mem {
        ...
        public:
            ...
            template <class U>
            LinearTaggedAllocator(const LinearTaggedAllocator<U>& other) noexcept : arena_(other.arena_) {}
            ...
            template <class U>
            friend class LinearTaggedAllocator;
        ...
        public:
            ...
            template <class U>
            PoolTaggedAllocator(const PoolTaggedAllocator<U>& other) noexcept : arena_(other.arena_), pool_(nullptr) {}
            ...
            template <class U>
            friend class PoolTaggedAllocator;
