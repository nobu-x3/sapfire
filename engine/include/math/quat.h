...
namespace sf::math {
    ...
    struct quat {
        ...
        // Dot product
        f32 dot(const quat& q) const { return x * q.x + y * q.y + z * q.z + w * q.w; }

        static f32 dot(const quat& a, const quat& b) { return a.x * b.x + a.y * b.y + a.z * b.z + a.w * b.w; }
        ...
        // Convert to vec4
        vec4 to_vec4() const { return vec4(x, y, z, w); }
    };
