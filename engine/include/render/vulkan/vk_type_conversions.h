...
inline VkFormat to_vk_format(Format format) {
    switch (format) {
        ...
        case Format::RGB10A2_UINT: return VK_FORMAT_A2R10G10B10_UINT_PACK32;
...
inline Format from_vk_format(VkFormat format) {
    switch (format) {
        ...
        case VK_FORMAT_A2R10G10B10_UNORM_PACK32: return Format::RGB10A2_UNORM;
        case VK_FORMAT_A2R10G10B10_UINT_PACK32: return Format::RGB10A2_UINT;
        case VK_FORMAT_B10G11R11_UFLOAT_PACK32: return Format::RG11B10_FLOAT;
...
inline VkPipelineStageFlags to_vk_pipeline_stage(ResourceState state) {
    switch (state) {
        case ResourceState::Common: return VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT;
        case ResourceState::VertexAndConstantBuffer: return VK_PIPELINE_STAGE_VERTEX_INPUT_BIT | VK_PIPELINE_STAGE_VERTEX_SHADER_BIT;
...
inline VkQueueFlags to_vk_queue_flags(CommandQueueType type) {
    switch (type) {
        case CommandQueueType::Direct: return VK_QUEUE_GRAPHICS_BIT;
