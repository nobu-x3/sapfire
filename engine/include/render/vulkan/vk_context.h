...
public:
    ...
    void transition_barrier(Buffer& buffer, ResourceState before, ResourceState after) override { VkContext::transition_barrier(buffer, before, after); }
    void transition_barrier(Texture& texture, ResourceState before, ResourceState after) override { VkContext::transition_barrier(texture, before, after); }
