...
namespace sf::render {
    ...
    enum class RenderAPI : u8 { None = 0, DX12, Vulkan };
    ...
    inline bool has_flag(ResourceUsage flags, ResourceUsage flag) { return (static_cast<u32>(flags) & static_cast<u32>(flag)) != 0; }
    ...
    inline ShaderStage operator|(ShaderStage a, ShaderStage b) { return static_cast<ShaderStage>(static_cast<u8>(a) | static_cast<u8>(b)); }
