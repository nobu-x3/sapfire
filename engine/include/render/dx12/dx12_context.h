...
public:
    ...
    void transition_barrier(Buffer& buffer, ResourceState before, ResourceState after) override { DX12Context::transition_barrier(buffer, before, after); }
    void transition_barrier(Texture& texture, ResourceState before, ResourceState after) override { DX12Context::transition_barrier(texture, before, after); }
    ...
    void draw_indexed(u32 index_count, u32 instance_count = 1, u32 start_index = 0, i32 base_vertex = 0, u32 start_instance = 0) override;
    void draw_indexed_instanced(u32 index_count_per_instance, u32 instance_count, u32 start_index = 0, i32 base_vertex = 0, u32 start_instance = 0) override;
