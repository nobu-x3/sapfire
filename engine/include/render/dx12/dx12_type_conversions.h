...
inline Format from_dxgi_format(DXGI_FORMAT format) {
    switch (format) {
        ...
        case DXGI_FORMAT_B8G8R8A8_UNORM_SRGB: return Format::BGRA8_UNORM_SRGB;
...
inline D3D12_BLEND to_d3d12_blend(Blend blend) {
    switch (blend) {
        ...
        case Blend::InvDstAlpha: return D3D12_BLEND_INV_DEST_ALPHA;
        case Blend::DstColor: return D3D12_BLEND_DEST_COLOR;
        case Blend::InvDstColor: return D3D12_BLEND_INV_DEST_COLOR;
