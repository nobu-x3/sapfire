...
namespace sf::render::dx12 {
    ...
    Shader compile(ShaderType type, const stl::string_view path, const stl::string_view entry_point, bool extract_root_signature = false);

    Shader compile(ShaderType type, const stl::wstring_view path, const stl::wstring_view entry_point, bool extract_root_signature = false);
