...
AssetBrowserWidget::AssetBrowserWidget(SQFileSystemModel* model, QWidget* parent) :
    ...
    m_TextureFilter->setIcon(QIcon(":/icons/texture_32"));
    ...
    m_MeshFilter->setIcon(QIcon(":/icons/mesh_32"));
    ...
    m_MaterialFilter = new QPushButton();
    m_MaterialFilter->setIcon(QIcon(":/icons/material_32"));
    m_MaterialFilter->setToolTip("Material");
    m_MaterialFilter->setCheckable(true);
    m_MaterialFilter->setChecked(true);
    m_MaterialFilter->setFixedSize(32, 32);
    ...
    m_ShaderFilter = new QPushButton();
    m_ShaderFilter->setIcon(QIcon(":/icons/shader_32"));
    m_ShaderFilter->setToolTip("Shader");
    m_ShaderFilter->setCheckable(true);
    m_ShaderFilter->setChecked(true);
    m_ShaderFilter->setFixedSize(32, 32);
    ...
    m_SceneFilter = new QPushButton();
    m_SceneFilter->setIcon(QIcon(":/icons/scene_32"));
    m_SceneFilter->setToolTip("Scene");
    m_SceneFilter->setCheckable(true);
    m_SceneFilter->setChecked(true);
    m_SceneFilter->setFixedSize(32, 32);
