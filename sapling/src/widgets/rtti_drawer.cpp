...
void RttiDrawer::draw_field(sf::rtti::rtti_object& rtti_obj, sf::rtti::rtti_field& field) {
    ...
    switch (field.type) {
        case sf::rtti::rtti_type::BOOL: {
            ...
            connect(checkbox, &QCheckBox::checkStateChanged, [field_ptr](Qt::CheckState state) {
                *reinterpret_cast<bool*>(field_ptr) = (state == Qt::Checked);
            });
        ...
        case sf::rtti::rtti_type::I32: {
            ...
            connect(spinbox, QOverload<int>::of(&QSpinBox::valueChanged), [field_ptr](int val) {
                *reinterpret_cast<sf::i32*>(field_ptr) = val;
            });
        ...
        case sf::rtti::rtti_type::U32: {
            ...
            connect(spinbox, QOverload<int>::of(&QSpinBox::valueChanged), [field_ptr](int val) {
                *reinterpret_cast<sf::u32*>(field_ptr) = static_cast<sf::u32>(val);
            });
            m_Layout->addRow(field_name, spinbox);
            break;
        }
        case sf::rtti::rtti_type::F32: {
            ...
            connect(spinbox, QOverload<double>::of(&QDoubleSpinBox::valueChanged), [field_ptr](double val) {
                *reinterpret_cast<sf::f32*>(field_ptr) = static_cast<sf::f32>(val);
            });
            m_Layout->addRow(field_name, spinbox);
            break;
        }
        case sf::rtti::rtti_type::STRING: {
            ...
            connect(lineedit, &QLineEdit::textChanged, [str_ptr](const QString& text) {
                *str_ptr = sf::stl::string(sf::mem::MemTag::Strings, text.toLatin1().data());
            });
